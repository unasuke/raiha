...
class RaihaTLSAEADTest < Minitest::Test
  ...
  def test_decrypt
    ...
    record = Raiha::TLS::Record.deserialize(RFC8448_1RTT_SERVER_PROTECTED_HADSHAKE_RECORD).first
    plain = aead.decrypt(ciphertext: record, phase: :handshake)
    whole_expected_message =
      RFC8448_1RTT_SERVER_HANDSHAKE_ENCRYPTED_EXTENSIONS +
      RFC8448_1RTT_SERVER_HANDSHAKE_CERTIFICATE +
      RFC8448_1RTT_SERVER_HANDSHAKE_CERTIFICATE_VERIFY +
      RFC8448_1RTT_SERVER_HANDSHAKE_FINISHED
